...
import { TradeDisputePanel } from '../components/trade/TradeDisputePanel'
...
// transforms, no React state, no reason to live inside the page.
          ...
          <Card className="p-5 mt-3">
            ...
            {dispute && (
              <TradeDisputePanel
                ...
                onContestAutoResolution={handleContestAutoResolution}
